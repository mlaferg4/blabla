...
admin_id = [7169822459]  # Сюда вставляем всех админов через запятую [123123, 837148, 12312] или только одного [123]
verification = True  # True - если хотите поставить проверку на человека
token = "7024568540:AAGke1gvdQRGetMwNe9cdX1mZeJuQwYRBcM"  # токен бота

vxod_worker = "/worker"

shop_name = "Narko"  # название шопа
admin_chat = "maksandro"  # username админа для связи без @
feedback_link = "https://t.me/chudoudoshop"  # ссылка на канал с отзывами

qiwi = "tytbydetqiwi"  # телефон киви или ник
card = "tytkarta"  # номер карты
bitcoin = "adresbitka"  # адрес битка
# ___________________________________________________________________
